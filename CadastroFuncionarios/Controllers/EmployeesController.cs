...
namespace CadastroFuncionarios.Controllers
{
    public class EmployeesController : Controller
    {
        ...
        public EmployeesController(CadastroFuncionariosContext context)
        {
            _context = context;
        }
        ...
        {
            var cadastroFuncionariosContext = _context.Employee.Include(e => e.Department);
            return View(await cadastroFuncionariosContext.ToListAsync());
        }
